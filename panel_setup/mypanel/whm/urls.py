...
urlpatterns = [
    ...
    path("db_replication/databases/", db_replication_databases_view, name="db_replication_databases"),
    path("db_replication/clients/", db_replication_clients_view, name="db_replication_clients"),
    path("db_replication/channels/", db_replication_channels_view, name="db_replication_channels"),
    path("db_replication/parity/", db_replication_parity_view, name="db_replication_parity"),
    path("db_replication/topology/", db_replication_topology_view, name="db_replication_topology"),
    ...
    path("api/db_replication/save_replica_client/", db_replication_save_replica_client, name="db_replication_save_replica_client"),
    path("api/db_replication/delete_replica_client/", db_replication_delete_replica_client, name="db_replication_delete_replica_client"),
    path("api/db_replication/node/<int:node_id>/", db_replication_get_node_details, name="db_replication_get_node_details"),
    path("api/db_replication/assign_db_replicas/", db_replication_assign_db_replicas, name="db_replication_assign_db_replicas"),
    path("api/db_replication/edit_inbound_channel/", db_replication_edit_inbound_channel, name="db_replication_edit_inbound_channel"),
    ...
    path("api/db_replication/resync/", db_replication_resync, name="db_replication_resync"),
    path("api/db_replication/skip_error/", db_replication_skip_error, name="db_replication_skip_error"),
    path("api/db_replication/parity_test/", db_replication_parity_test, name="db_replication_parity_test"),
    path("api/db_replication/toggle_readonly/", db_replication_toggle_readonly, name="db_replication_toggle_readonly"),
    path("api/db_replication/channel_action/", db_replication_channel_action, name="db_replication_channel_action"),
    path("api/db_replication/kill_thread/", db_replication_kill_thread, name="db_replication_kill_thread"),
    path("api/db_replication/test_connection/", db_replication_test_connection, name="db_replication_test_connection"),
]
