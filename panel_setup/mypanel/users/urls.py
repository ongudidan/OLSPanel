...
urlpatterns = [
    ...
    path('db_user_add/', db_user_add, name='db_user_add'),
    path('db_assign_user/', db_assign_user, name='db_assign_user'),
    path('db_privileges/<str:db>/<str:db_user>/', db_privileges, name='db_privileges'),
    path('db_revoke_user/<str:db>/<str:db_user>/', db_revoke_user, name='db_revoke_user'),
