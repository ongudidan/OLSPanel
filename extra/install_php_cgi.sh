...
install_all_cgi_php_versions_centos() {
    ...
    for version in 8.2 8.3; do
        ...
        case "$version" in
            8.2) rpm_url="https://ongudidan.github.io/OLSPanel/repo-files/centos-php82-cgi/php8.2-8.2.0-1.el9.x86_64.rpm" ;;
            8.3) rpm_url="https://ongudidan.github.io/OLSPanel/repo-files/centos-php83-cgi/php8.3-8.3.0-1.el9.x86_64.rpm" ;;
            *) continue ;;
        esac
...
install_repo_el8() {
    for version in 8.2; do
        ...
        case "$version" in
            8.2) rpm_url="https://ongudidan.github.io/OLSPanel/repo-files/centos-php82-cgi/php8.2-8.2.0-1.el8.x86_64.rpm" ;;
            *) continue ;;
        esac
...
install_all_cgi_php_versions_ubuntu20() {
    ...
    for version in 8.2; do
        ...
        case "$version" in
            8.2)
                rpm_url="https://ongudidan.github.io/OLSPanel/repo-files/ubunto-20-php82-cgi/php8.2_8.2.0-1_amd64.deb"
                ;;
            *)
                continue
                ;;
...
install_all_cgi_php_versions_ubuntu22() {
    ...
    echo "deb [trusted=yes] https://ongudidan.github.io/OLSPanel/repo-files/ubunto-22-php82-cgi/php82-repo ./" \
